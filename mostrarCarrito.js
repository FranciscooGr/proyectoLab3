document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("totalProductos").textContent = contador;
    ...
    const restarZapatilla = document.getElementById("restarZapatilla"); 
        agregarZapatilla.addEventListener("click", function(){
            ...
            document.getElementById("subTotal").textContent = precioSuma; 
        ...
        restarZapatilla.addEventListener("click", function(){
            ...
            document.getElementById("subTotal").textContent = precioResta; 
